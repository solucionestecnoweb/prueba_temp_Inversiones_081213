...
class AccountMove(models.Model):
    ...
    #Cantidad por Descuento
    am_discount1 = fields.Float(string="Descuento #1", compute="_compute_discount_amount_total", store=True)
    am_discount2 = fields.Float(string="Descuento #2", compute="_compute_discount_amount_total", store=True)
    ...
    def _compute_amount(self):
        ...
        for move in self:
            ...
            move._compute_discount_amount_total()
